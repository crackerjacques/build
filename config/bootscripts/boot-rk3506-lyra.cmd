...
#
# Luckfox Lyra (RK3506) mainline: debug console is uart0 (ttyS0) @ 0xff0a0000.
# earlycon is on by default (address form, so it inherits U-Boot's baud) to make
# first-boot bring-up visible even before the 8250 driver claims the port.
...
if test "${console}" = "ttyS0,1500000n8"; then setenv console "both"; fi
if test "${console}" = "display" || test "${console}" = "both"; then setenv consoleargs "console=tty1"; fi
if test "${console}" = "serial" || test "${console}" = "both"; then setenv consoleargs "console=ttyS0,1500000n8 ${consoleargs}"; fi
if test "${earlycon}" = "on"; then setenv consoleargs "earlycon=uart8250,mmio32,0xff0a0000 ${consoleargs}"; fi
